...
def nuscenes_data_prep(root_path, version, dataset_name, max_sweeps=10,radar_max_sweeps=5):
    nu_ds.create_nuscenes_infos(root_path, version=version, max_sweeps=max_sweeps,radar_max_sweeps=radar_max_sweeps)
    name = "infos_trainD1.pkl"
